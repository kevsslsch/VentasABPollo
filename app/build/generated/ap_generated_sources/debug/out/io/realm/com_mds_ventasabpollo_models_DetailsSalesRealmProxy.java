...
public class com_mds_ventasabpollo_models_DetailsSalesRealmProxy extends com.mds.ventasabpollo.models.DetailsSales
    implements RealmObjectProxy, com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface {

    static final class DetailsSalesColumnInfo extends ColumnInfo {
        ...
        DetailsSalesColumnInfo(OsSchemaInfo schemaInfo) {
            super(16);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("DetailsSales");
        ...
        DetailsSalesColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new DetailsSalesColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final DetailsSalesColumnInfo src = (DetailsSalesColumnInfo) rawSrc;
            final DetailsSalesColumnInfo dst = (DetailsSalesColumnInfo) rawDst;
    ...
    private DetailsSalesColumnInfo columnInfo;
    private ProxyState<com.mds.ventasabpollo.models.DetailsSales> proxyState;

    com_mds_ventasabpollo_models_DetailsSalesRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (DetailsSalesColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.mds.ventasabpollo.models.DetailsSales>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("DetailsSales", 16, 0);
    ...
    public static DetailsSalesColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new DetailsSalesColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "DetailsSales";
    }

    @SuppressWarnings("cast")
    public static com.mds.ventasabpollo.models.DetailsSales createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.mds.ventasabpollo.models.DetailsSales obj = realm.createObjectInternal(com.mds.ventasabpollo.models.DetailsSales.class, true, excludeFields);

        final com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface objProxy = (com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) obj;
        if (json.has("ruta")) {
            if (json.isNull("ruta")) {
    ...
    public static com.mds.ventasabpollo.models.DetailsSales createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.mds.ventasabpollo.models.DetailsSales obj = new com.mds.ventasabpollo.models.DetailsSales();
        final com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface objProxy = (com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_mds_ventasabpollo_models_DetailsSalesRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.mds.ventasabpollo.models.DetailsSales.class), false, Collections.<String>emptyList());
        io.realm.com_mds_ventasabpollo_models_DetailsSalesRealmProxy obj = new io.realm.com_mds_ventasabpollo_models_DetailsSalesRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.mds.ventasabpollo.models.DetailsSales copyOrUpdate(Realm realm, DetailsSalesColumnInfo columnInfo, com.mds.ventasabpollo.models.DetailsSales object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.mds.ventasabpollo.models.DetailsSales) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.mds.ventasabpollo.models.DetailsSales copy(Realm realm, DetailsSalesColumnInfo columnInfo, com.mds.ventasabpollo.models.DetailsSales newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.mds.ventasabpollo.models.DetailsSales) cachedRealmObject;
        }

        com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface realmObjectSource = (com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) newObject;

        Table table = realm.getTable(com.mds.ventasabpollo.models.DetailsSales.class);
        ...
        io.realm.com_mds_ventasabpollo_models_DetailsSalesRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.mds.ventasabpollo.models.DetailsSales object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mds.ventasabpollo.models.DetailsSales.class);
        long tableNativePtr = table.getNativePtr();
        DetailsSalesColumnInfo columnInfo = (DetailsSalesColumnInfo) realm.getSchema().getColumnInfo(com.mds.ventasabpollo.models.DetailsSales.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.rutaIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$ruta(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.visitaIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$visita(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.clave_articuloIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$clave_articulo(), false);
        String realmGet$articulo = ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$articulo();
        if (realmGet$articulo != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.articuloIndex, rowIndex, realmGet$articulo, false);
        }
        String realmGet$nombre_articulo = ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$nombre_articulo();
        ...
        String realmGet$nombre_unidad = ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$nombre_unidad();
        ...
        String realmGet$descripcion_extendida = ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$descripcion_extendida();
        ...
        Table.nativeSetDouble(tableNativePtr, columnInfo.cantidadIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$cantidad(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.precioIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$precio(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.IVAIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$IVA(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.IEPSIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$IEPS(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.tasa_IVAIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$tasa_IVA(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.tasa_IEPSIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$tasa_IEPS(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.importeIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$importe(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.enviadoIndex, rowIndex, ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$enviado(), false);
        String realmGet$fecha_enviado = ((com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) object).realmGet$fecha_enviado();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        DetailsSalesColumnInfo columnInfo = (DetailsSalesColumnInfo) realm.getSchema().getColumnInfo(com.mds.ventasabpollo.models.DetailsSales.class);
        com.mds.ventasabpollo.models.DetailsSales object = null;
        while (objects.hasNext()) {
            object = (com.mds.ventasabpollo.models.DetailsSales) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.mds.ventasabpollo.models.DetailsSales object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mds.ventasabpollo.models.DetailsSales.class);
    ...
    public static com.mds.ventasabpollo.models.DetailsSales createDetachedCopy(com.mds.ventasabpollo.models.DetailsSales realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.mds.ventasabpollo.models.DetailsSales unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.mds.ventasabpollo.models.DetailsSales();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.mds.ventasabpollo.models.DetailsSales) cachedObject.object;
            }
            unmanagedObject = (com.mds.ventasabpollo.models.DetailsSales) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface unmanagedCopy = (com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) unmanagedObject;
        com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface realmSource = (com_mds_ventasabpollo_models_DetailsSalesRealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("DetailsSales = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_mds_ventasabpollo_models_DetailsSalesRealmProxy aDetailsSales = (com_mds_ventasabpollo_models_DetailsSalesRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aDetailsSales.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aDetailsSales.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aDetailsSales.proxyState.getRow$realm().getIndex()) return false;
